...
import FacebookAuthLogin from "./subComponents/FacebookAuthLogin";
import LinkedInLogin from "./subComponents/LinkedInLogin";
...
const Login: React.FC<LoginProps> = () => {
  ...
  const handleLoginClick = async (e: FormEvent) => {
    ...
    try {
      ...
      toast.error(`There was an error while login:${err}`);
    }
  };

  const redirectUrl = `https://github.com/login/oauth/authorize?scope=user:email&client_id=${GITHUB_CLIENT_ID}`;
          ...
          <Box sx={{ p: 1, mt: 2 }}>
            ...
            >
              ...
              >
                ...
                <LinkedInLogin clientId={LINKEDIN_CLIENT_ID} />
                <FacebookAuthLogin clientId={FACEBOOK_CLIENT_ID} />
                <IconButton aria-label="Github" onClick={handleGithubLogin}>
                  <GitHubIcon />
                </IconButton>
              </Box>
            </Box>
